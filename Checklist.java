...
public class Checklist {
    ...
    public static void Checklist() {
        ...
        buttonDone.addActionListener(e -> {checklist.dispose();
            ...
            if (g % 10 == 1){
              JOptionPane.showMessageDialog(null,"It's your " + g + "st done list", "Accomplishment",JOptionPane.INFORMATION_MESSAGE);}
            else if (g % 10 == 2){
              JOptionPane.showMessageDialog(null,"It's your " + g + "nd done list", "Accomplishment",JOptionPane.INFORMATION_MESSAGE);}
            else if (g % 10 == 3){
              JOptionPane.showMessageDialog(null,"It's your " + g + "rd done list", "Accomplishment",JOptionPane.INFORMATION_MESSAGE);}
            else {
              JOptionPane.showMessageDialog(null,"It's your " + g + "th done list", "Accomplishment",JOptionPane.INFORMATION_MESSAGE);} });
